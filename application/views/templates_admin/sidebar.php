  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-text mx-3"> PENGGAJIAN PEGAWAI MTS NURUL QUR'AN</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('admin/dataPegawai') ?>">Data Pegawai Sekolah</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('admin/dataAbsensi'); ?>">Data Absensi Pegawai</a>
            <a class="collapse-item" href="<?= base_url('admin/potonganGaji'); ?>">Setting Potongan Gaji</a>
            <a class="collapse-item" href="<?= base_url('admin/dataPenggajian'); ?>">Data Gaji Pegawai</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('admin/laporanGaji'); ?>">Laporan Gaji Pegawai</a>
            <a class="collapse-item" href="<?= base_url('admin/laporanAbsensi'); ?>">Laporan Absensi</a>
            <a class="collapse-item" href="<?= base_url('admin/slipGaji'); ?>">Slip Gaji Pegawai</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h4 class="font-weight-bold">MTS NURUL QUR'AN</h4>
