...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Data Gaji Pegawai Sekolah</h1>
  </div>

  <div class="card mb-3">
    <div class="card-header bg-success text-white">
      Filter Data Gaji Pegawai Sekolah
    </div>
    <div class="card-body">
  ...
  <div class="alert alert-info">
    Menampilkan data gaji pegawai Sekolah bulan: <span class="font-weight-bold"><?= $bulan; ?></span> tahun: <span class="font-weight-bold"><?= $tahun; ?></span>
  </div>
