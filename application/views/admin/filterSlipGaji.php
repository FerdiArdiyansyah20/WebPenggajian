...
<div class="container-fluid">
  ...
  <div class="card mx-auto" style="width: 35%;">
    <div class="card-header bg-success text-white text-center">
      Filter Slip Gaji Pegawai Sekolah
    </div>
    ...
    <form action="<?= base_url('admin/slipGaji/cetakSlipGaji'); ?>" method="post">
      <div class="card-body">
        ...
        <label for="inputPassword" class="col-sm-3 col-form-label">Nama</label>
          <div class="col-sm-9">
            <select name="nama_pegawai" id="" class="form-control">
              <option value="">--Pilih Pegawai Sekolah--</option>
        ...
        <button type="submit" class="btn btn-success btn-block"><i class="fas fa-print"></i> Cetak Slip Gaji</button>
      </div>
    </form>
